...
@RequestMapping("/students") // students endpoint'i ile gelen reguestler için bu sınıfa bakılacağını belirtiyorum.
public class StudentController {
    ...
    // http://localhost:8080/sptringmvc/students/update?id=1
    @GetMapping("/update")
    ...
    // http://localhost:8080/sptringmvc/students/delete/1
